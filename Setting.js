...
global.mongodb = process.env.MONGODB_URI || "mongodb+srv://mohsin:mohsin@cluster0.iauaztt.mongodb.net/?retryWrites=true&w=majority" ;            // PUT MONGODB KEY HERE, WITHOUT MONGODB YOUR BOT WILL NOT RUN
...
global.sudo  =  process.env.SUDO || "233596780685" ;          // DON'T REMOVE
global.mztit = process.env.MZTIT ||"ODS TECHNOLOGIES",               // ADD YOUR TITLE, ONE WORD WILL BE MORE BETTER
...
module.exports = {
  ...
  //==============================[COMPULSORY]=====================================
  sessionName: process.env.SESSION_ID || '13_06_2024_SIGMA_MD_bmpWS5Cp_MAHER_ZUBAIR',              // PUT YOUR SESSION ID
  botname: process.env.BOT_NAME       || 'ODS TECHNOLOGIES',         // ADD YOUR BOT NAME
  ownername:  process.env.OWNER_NAME  || `ODS TECHNOLOGIES, // ADD YOUR NAME
  ...
  //==============================[WHAT'SAPP FEATURES]==============================
  author:  process.env.PACK_AUTHER  || 'ODS TECHNOLOGIES',      // ADD YOUR STICKER AUTHOR NAME
  ...
  packname:  process.env.PACK_NAME  || "ODSTECH" ,          // ADD YOUR STICKER PACKNAME
  ...
  warncount : process.env.WARN_COUNT || 10,                 // WARN LIMITS
  ...
  antifake :   process.env.FAKE_COUNTRY_CODE || '',     // ANTIFAKE NUMBER CAN'T JOIN GROUPS
  ...
  OPENAI_API_KEY: process.env.OPENAI_API_KEY ||'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' ,    // ADD YOUR OPEN AI KEY IF YOU HAVE
